...
<div id="s2-db-basic">
	<table class="dupx-opts">
		...
		<tr>
			<td>Host:</td>
			<td><input type="text" name="dbhost" id="dbhost" required="true" value="<?php echo htmlspecialchars($GLOBALS['DUPX_AC']->dbhost); ?>" placeholder="localhost" /></td>
		</tr>
		<tr>
			<td>Database:</td>
			<td>
				<input type="text" name="dbname" id="dbname" required="true" value="<?php echo htmlspecialchars($GLOBALS['DUPX_AC']->dbname); ?>"  placeholder="new or existing database name"  />
		...
		<tr><td>User:</td><td><input type="text" name="dbuser" id="dbuser" required="true" value="<?php echo htmlspecialchars($GLOBALS['DUPX_AC']->dbuser); ?>" placeholder="valid database username" /></td></tr>
		<tr><td>Password:</td><td><input type="text" name="dbpass" id="dbpass" value="<?php echo htmlspecialchars($GLOBALS['DUPX_AC']->dbpass); ?>"  placeholder="valid database user password"   /></td></tr>
	</table>
</div>
<br/><br/>
