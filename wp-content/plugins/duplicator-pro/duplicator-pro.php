...
/** ================================================================================
  ...
  ================================================================================ */
/*:
this register_activation_hook must be in the main entry file, in our case, in this file
*/

// RSR - from albert's db checker - need to refactor so commenting out right now
//define('DUP_PRO_DIR', dirname( __FILE__ ));
//define('DUP_PRO_DS',DIRECTORY_SEPARATOR);
//register_activation_hook( __FILE__, 'dup_pro_activation');
//function dup_pro_activation()
//{
//    require_once DUP_PRO_DIR . DUP_PRO_DS . 'classes'. DUP_PRO_DS .'environment'. DUP_PRO_DS .'class.environment.checker.php';
//
//    $Env_Checker=new DUP_PRO_Environment_Checker();
//    $ok=$Env_Checker->check();
...
// register_deactivation_hook( __FILE__, 'dpro_deactivation');
// function dpro_deactivation()
// {
