        ...
        try {
            ...
            if ((!$skipArchiveFinalization) && ($createState->working == false)) {
                ...
                if ($expandStateEntity == null) {
                    ...
                    $expandStateEntity->working                = true;
                    $expandStateEntity->expectedDirectoryCount = count($scanReport->ARC->Dirs) - 1 - $createState->skippedDirectoryCount; // Since we never create the root
                    $expandStateEntity->expectedFileCount      = count($scanReport->ARC->Files) + 1 - $createState->skippedFileCount;    // database.sql will be in there
                }
