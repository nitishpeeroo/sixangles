...
<style>
	...
	i.data-size-help { float:right; margin-right:5px; display: block; font-size: 11px}
	div#dpro-confirm-area {color:maroon; display:none; font-size:14px; line-height:30px; font-weight: bold; margin: -5px 0 10px 0}
...
<form id="form-duplicator" method="post" action="<?php echo $package_list_url ?>">
	...
	<div id="dpro-confirm-area">
		<label for="dpro-confirm-check"><?php DUP_PRO_U::_e('Checkbox was left checked in "Quick Filters".  Do you want to continue?') ?><br/>
		...
		<small style="font-weight:normal"><?php DUP_PRO_U::_e('To apply a "Quick Filter" click the "Add Filters & Rescan" button') ?></small>
	</div>
