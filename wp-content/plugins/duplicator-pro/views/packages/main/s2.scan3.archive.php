...
defined("ABSPATH") or die("");
	...
	$legacy_sql_string = ($Package->Database->Compatible) ? "<i style='color:#AF0000'>".DUP_PRO_U::__('Compatibility Mode Enabled').'</i>' : '';
?>
...
<div id="dup-archive-details" style="display:none">
	...
	<div class="info">
		...
		<label><?php DUP_PRO_U::_e('Archive Engine');?>:</label> <a href="?page=duplicator-pro-settings&tab=package" target="_blank"><?php echo $archive_build_mode; ?></a>
	</div><br/>
